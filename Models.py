...
# Code borrowed from Shark-NLP's project (https://github.com/Shark-NLP/DiffuSeq)
# Original source: https://github.com/Shark-NLP/DiffuSeq/blob/main/diffuseq/transformer_model.py
# Licensed under the MIT License (see LICENSE.txt)
# Copyright (c) 2023 Shark-NLP
